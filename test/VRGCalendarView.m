...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:(234/255.0) green:(234/255.0) blue:(234/255.0) alpha:1].CGColor);
    ...
    NSArray *weekdays = [[NSArray alloc] init];
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        [date drawInRect:CGRectMake(targetX+2, targetY+10, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:17] lineBreakMode:NSLineBreakByCharWrapping alignment:NSTextAlignmentCenter];
    }

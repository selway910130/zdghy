...
// case view is almost the same with notice view, but case view have image view;
- (void)viewDidLoad
{
    [super viewDidLoad];
    NSLog(@"/////////////////////////案例查询/////////////////////////");
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGSize titleLabelSize = [[tempNotice objectForKey:@"caseName"] sizeWithFont:[UIFont boldSystemFontOfSize:17]
...
{
    NSDictionary *tempCase = [self.cases objectAtIndex:indexPath.row];

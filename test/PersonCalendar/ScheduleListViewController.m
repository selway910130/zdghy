...
// refresh list if any change made
...
// search the day to get list of events
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGSize titleLabelSize = [[tempEvent objectForKey:@"scheduleName"] sizeWithFont:[UIFont boldSystemFontOfSize:17]
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    // set tite color depends on schedule level
...
// get detail of schedule user selected, jump to detail view
...
#pragma mark - edit and create button
